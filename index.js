...
function DockerNames() {
  ...
  "zen"
    ...
    this.right = [
        ...
        // Kurt Friedrich Gödel an Austrian considered along with Aristotle, Alfred Tarski and Gottlob Frege to be one of the most significant logicians in history - https://en.wikipedia.org/wiki/Kurt_G%C3%B6del
        "godel",
